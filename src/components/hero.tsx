...
function Hero() {
  return (
    <div className="w-full bg-[#E9F3F4]">
      <div className="max-w-[1200px] w-full flex flex-col md:flex-row justify-center m-auto bg-[#E9F3F4] h-auto md:h-[750px] px-10 md:px-20 py-5 md:py-10 mb-10">
        ...
        <div className=" mt-10 md:mt-32 mb-10 w-full">
          <PaymentCard />
        </div>
      </div>
    </div>
